...
import { Card, Grid, Statistic,Tooltip,Button, Space } from "antd"
...
function AreaChartPanel(){
    ...
    return(
        <Card title={intl.formatMessage({id:"monitoring.areasales.title"})} extra={<Tooltip title={intl.formatMessage({id:"global.continue"})}><Button disabled={!overly} type="text" onClick={()=>{onRefresh()}} icon={<StepForward size={14} />} /></Tooltip>}>
...
function AgentChartPanel(props:{onMore:()=>void}){
  ...
  return(
    <Card title={intl.formatMessage({id:"monitoring.agent.title"})} extra={<Tooltip title={intl.formatMessage({id:"global.more"})}><Button onClick={()=>{props.onMore()}} type="text" icon={<MoreVertical size={14} />} /></Tooltip>}>
...
function TransformChartPanel(){
  ...
  return(
    <Card title={intl.formatMessage({id:"monitoring.transform.title"})} extra={<Space.Compact><Button disabled={seed < 1} onClick={()=>{onReduceSeed()}} type="text" icon={<ArrowLeft size={14} />} /><Button disabled={seed >= chartData.length -1} onClick={()=>{onPlusSeed()}} type="text" icon={<ArrowRight size={14} />} /></Space.Compact>}>
