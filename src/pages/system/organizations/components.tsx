...
function DeptDetailsDrawer(props:DrawerProps&{dept?:Dept}){
    ...
    return(
        <>
        <Drawer {...props} title={intl.formatMessage({id:"order.drawer.details.title"})} extra={<Space><Button key="edit-btn" icon={<SquarePen size={14} />}>{intl.formatMessage({id:"global.edit"})}</Button></Space>}>
...
export { useDeptDrawer,useUserDrawer }