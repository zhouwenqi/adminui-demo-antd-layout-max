...
import type { AvatarPosition, BreadcrumbIconVisible, LayoutType, Position, Theme } from '@adminui-dev/antd-layout';
import { ColorPicker, Segmented, Switch, theme } from 'antd';
...
export default function(){
    ...
    const { layoutConfig,languages,locale } = useConfigState()
    ...
    const data:ConfigData[]=[
        {title:intl.formatMessage({id:"setting.theme.title"}),element:(<Segmented styles={{label:segmentItem,icon:segmentIcon}} options={themeOptions} defaultValue={layoutConfig.theme} value={layoutConfig.theme} onChange={(e)=>{setLayoutConfig({...layoutConfig,theme: e as Theme})}} />)},
        ...
        {title:intl.formatMessage({id:"setting.theme.color"}),element:(<ColorPicker defaultValue={layoutConfig.primaryColor} onChange={(e)=>{setLayoutConfig({...layoutConfig,primaryColor:e.toHexString()})}} />)},
